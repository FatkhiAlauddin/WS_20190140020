...
import com.example.Assigment.exceptions.NonexistentEntityException;
import com.example.Assigment.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_Assigment_jar_0.0.1-SNAPSHOTPU");
